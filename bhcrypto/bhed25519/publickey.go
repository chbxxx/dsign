...
func GetEdPubkeyByNum(y *big.Int) bhcrypto.BhPublicKey {
	pub := &PublicKey{}
	pub.Curve = Edwards()
...
func (p PublicKey) ToECDSA() *ecdsa.PublicKey {
	...
	pkecdsa.Curve = Edwards()
	return &pkecdsa
}

func (p PublicKey) IsEqual(otherPubKey bhcrypto.BhPublicKey) bool {
	return p.X.Cmp(otherPubKey.GetX()) == 0 &&
		p.Y.Cmp(otherPubKey.GetY()) == 0
}
